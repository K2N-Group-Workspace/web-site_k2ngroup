    ...
    <div className="mx-[2rem] my-[5rem] font-roboto lg:mx-[10rem]">
      <div className="flex flex-col justify-start gap-[10rem] lg:mx-0 lg:flex-row">
        <div className="flex flex-col justify-start gap-[2rem]">
          <div>
            <h1 className="pt-[5rem] text-sm font-bold text-white lg:text-5xl">
              Localisation
            </h1>
            <p className="py-4 text-white lg:w-[35rem]">
          ...
          <div className="flex gap-6">
            ...
            <div className="mt-1 flex flex-col gap-2">
              <h1 className="font-bold text-white lg:text-4xl">Localisation</h1>
              <p className="text-white lg:w-[35rem]">
          ...
          <div className="flex gap-6">
            ...
            <div className="mt-2 flex flex-col gap-2">
              ...
              <p className="text-white lg:w-[35rem]">Samedi : 09H00 - 14H00</p>
            </div>
          </div>
        </div>
        <div>
          <div className="mt-[5rem] flex w-full items-center justify-center px-4">
            <div className="w-full max-w-4xl">
              <iframe
                id="map-canvas"
                className="left-0 top-0 h-[40rem] w-[37rem] border border-gray-300 shadow-lg lg:h-[40rem] lg:w-[67rem]"
                frameBorder="0"
                scrolling="no"
