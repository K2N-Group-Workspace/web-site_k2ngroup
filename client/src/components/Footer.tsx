...
const Footer = () => {
  ...
  return (
    <div className=" dark:bg-gray-900  sm:p-12 p-4 text-[.8rem] md:text-[1.2rem]">
      ...
      <div className=" w-full max-w-screen ">
        <div className="flex justify-between  items-center sm:px-4 py-6   ">
          ...
          <div>
            <ul className="text-white gap-4 justify-center md:flex  dark:text-gray-400 font-medium items-center">
              <li className="mb-4">
                <a
                  href="https://www.facebook.com/k2n_group_sarl/"
                  className="hover:underline text-12"
                >
                  <FaFacebook className="md:text-[2rem]" />
                </a>
              </li>
              <li className="mb-4">
                <a
                ...
                >
                  <FaInstagram className="md:text-[2rem]" />
                </a>
              </li>
              <li className="mb-4">
                <a
                  ...
                  className="hover:underline"
                >
                  <FaLinkedin className="md:text-[2rem]" />
                </a>
              </li>
              <li>
                <LanguageSelector />
      ...
      <hr className="px-4 h-0.5 bg-gray-100 " />
      <span className="md:text-sm text-[.8rem] mt-2 text-gray-500 dark:text-gray-300 sm:text-center">
        Copyright © 2025 K2N GROUP, Tous les droits réservés.{" "}
      </span>
    </div>
  );
};
