...
var Slot2 = React15.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime9.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children: React15.isValidElement(newElement) ? React15.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime9.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children });
});
Slot2.displayName = "Slot";
var SlotClone2 = React15.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
function isSlottable2(child) {
  return React15.isValidElement(child) && child.type === Slottable2;
}
